...
Pre-Lecture:
- setState should NEVER go inside of render (infinite loop)
- Remember your lifecycle methods. componentDidMount is your friend!
- Please don't skip deliverables
- TEST TEST TEST TEST TEST


Pain Points, Questions, Monologues:
- where should we fetch? ===> initial get should be in componentDidMount
- Removing image pain pt
- Where should all the states be?
- Where do put state for eaten 
    - false flag nested in Object
    - eaten array of ids 
- pagination / more sushi btn ===> onClick on native tags vs. custom components
- class v functional components 
- passing props to siblings (cough lift state cough)


Icebox (where my heart used to be)
- how would we represent this in the objects?  ==> needing to make a copy of an object in an array in state 
- componentWillUnmount... explain plz
- forms uncontrolled v controlled
